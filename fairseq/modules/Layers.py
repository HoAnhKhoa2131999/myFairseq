...
from fairseq.modules.SubLayers import MultiHeadAttention, PositionwiseFeedForward
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, dec_input_real,dec_input_phase, enc_output_real,enc_output_phase, non_pad_mask=None, slf_attn_mask=None, dec_enc_attn_mask=None):
        ...
        dec_output_real,dec_output_phase, dec_enc_attn = self.enc_attn(dec_output_real,
                                                                       enc_output_real,
                                                                       enc_output_real,
                                                                       dec_output_phase,
                                                                       enc_output_phase,
